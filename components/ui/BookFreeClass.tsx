    ...
    <>
      ...
      <div className="relative">
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent 
            className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[90vw] sm:w-[450px] max-h-[90vh] bg-white text-gray-800 rounded-lg shadow-lg [&>button]:hidden"
          >
            <div className="relative flex flex-col max-h-[90vh]">
              <div className="sticky top-0 bg-white z-20 border-b">
                ...
                <DialogHeader className="pt-4 px-6 pb-4">
